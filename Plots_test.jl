...
p3 = plot(x=0:23, y=hmdata3[:x1], ymin=ymins, ymax = ymaxs, Geom.point, Geom.smooth(method=:loess, smoothing=0.9), Geom.errorbar, light_panel)
...
p4 = plot(x=0:23, y=hmdata4[:x1], ymin=ymins, ymax = ymaxs, Geom.point, Geom.smooth(method=:loess, smoothing=0.9), Geom.errorbar, light_panel)
